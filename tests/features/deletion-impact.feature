Feature: Delete impacts in a Disruption
    ...
    Scenario: Delete an impact with id invalid
    ...
    Scenario: Delete an impact with id not in url
    ...
    Scenario: Delete an impact and update status in disruptions
        ...
        I fill in header "X-Coverage" with "jdr"
        I fill in header "Authorization" with "d5b0148c-36f4-443c-9818-1f2f74a00be0"
        When I get "/disruptions?current_time=2014-04-25T14:00:00Z&publication_status[]=ongoing&start_page=1&depth=2"
        Then the status code should be "200"
        And the header "Content-Type" should be "application/json"
